...
class TemplateValidator(Schema):
    ...
    block_structure = fields.List(required=False, cls_or_instance=fields.String)
    block_count = fields.Integer(required=False)
    category = fields.String(required=False, validate=OneOf(["General", "Terms", "Home", "Privacy"]))